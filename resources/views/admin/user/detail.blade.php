...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-4 col-lg-5">
            ...
            <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete-modal" style="width: 100%">Delete User</button>
            <!-- Delete Modal -->
            <div id="delete-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-body p-4">
                            <form action="{{ route('admin.user.delete', Crypt::encryptString($data->id)) }}" method="POST">
                                @csrf
